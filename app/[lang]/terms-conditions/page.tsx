        ...
        <div className="space-y-12">
          ...
          <section className="group">
            <h2 className="text-2xl font-bold text-[#0E7C7B] mb-4 flex items-center gap-3">
              ...
              {termsConditions.sections.useOfWebsite.title}
            </h2>
            <div className="pl-11 border-l-2 border-[#E0F2FE] ml-4 group-hover:border-[#4195A3]/30 transition-colors duration-300">
              <p className="text-[#475569] leading-relaxed whitespace-pre-line">
                {termsConditions.sections.useOfWebsite.content}
              </p>
            </div>
          </section>
          ...
          <section className="group">
            <h2 className="text-2xl font-bold text-[#0E7C7B] mb-4 flex items-center gap-3">
              ...
              {termsConditions.sections.intellectualProperty.title}
            </h2>
            <div className="pl-11 border-l-2 border-[#E0F2FE] ml-4 group-hover:border-[#4195A3]/30 transition-colors duration-300">
              <p className="text-[#475569] leading-relaxed whitespace-pre-line">
                {termsConditions.sections.intellectualProperty.content}
              </p>
            </div>
          </section>
          ...
          <section className="group">
            <h2 className="text-2xl font-bold text-[#0E7C7B] mb-4 flex items-center gap-3">
              ...
              {termsConditions.sections.appointmentPolicies.title}
            </h2>
            <div className="pl-11 border-l-2 border-[#E0F2FE] ml-4 group-hover:border-[#4195A3]/30 transition-colors duration-300">
              <p className="text-[#475569] leading-relaxed whitespace-pre-line">
                {termsConditions.sections.appointmentPolicies.content}
              </p>
            </div>
          </section>
          ...
          <section className="group">
            <h2 className="text-2xl font-bold text-[#0E7C7B] mb-4 flex items-center gap-3">
              ...
              {termsConditions.sections.healthDisclaimer.title}
            </h2>
            <div className="pl-11 border-l-2 border-[#E0F2FE] ml-4 group-hover:border-[#4195A3]/30 transition-colors duration-300">
              <p className="text-[#475569] leading-relaxed whitespace-pre-line">
                {termsConditions.sections.healthDisclaimer.content}
              </p>
            </div>
          </section>
          ...
          <section className="group">
            <h2 className="text-2xl font-bold text-[#0E7C7B] mb-4 flex items-center gap-3">
              ...
              {termsConditions.sections.limitationLiability.title}
            </h2>
            <div className="pl-11 border-l-2 border-[#E0F2FE] ml-4 group-hover:border-[#4195A3]/30 transition-colors duration-300">
              <p className="text-[#475569] leading-relaxed whitespace-pre-line">
                {termsConditions.sections.limitationLiability.content}
              </p>
            </div>
          </section>
          ...
          <section className="group">
            <h2 className="text-2xl font-bold text-[#0E7C7B] mb-4 flex items-center gap-3">
              ...
              {termsConditions.sections.changesToPolicies.title}
            </h2>
            <div className="pl-11 border-l-2 border-[#E0F2FE] ml-4 group-hover:border-[#4195A3]/30 transition-colors duration-300">
              <p className="text-[#475569] leading-relaxed whitespace-pre-line">
                {termsConditions.sections.changesToPolicies.content}
              </p>
            </div>
          </section>
        </div>
