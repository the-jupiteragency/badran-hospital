...
export function CollapsibleBtn() {
  ...
  return (
    <div ref={containerRef} className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3 font-sans">
      {/* Expanded Actions */}
      <div 
      ...
      >
        <div className="flex items-center gap-2">
            <span className="bg-white/90 text-gray-700 text-xs py-1 px-2 rounded-md shadow-sm">WhatsApp</span>
            <WhatsAppButton className="shadow-lg rounded-full bg-white p-1" />
        </div>
        
         <div className="flex items-center gap-2">
            <span className="bg-white/90 text-gray-700 text-xs py-1 px-2 rounded-md shadow-sm">Chatbot</span>
